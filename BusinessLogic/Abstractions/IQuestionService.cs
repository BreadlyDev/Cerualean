...
public interface IQuestionService
{
    ...
    Task<RichQuestionDto?> GetWithOptionsByIdAsync(int id, CancellationToken cancellationToken = default);
    Task<ICollection<QuestionDto>> GetListByTestAsync(int testId, CancellationToken cancellationToken = default);
    Task<ICollection<RichQuestionDto>> GetListWithOptionsByTestAsync(int testId, CancellationToken cancellationToken = default);
