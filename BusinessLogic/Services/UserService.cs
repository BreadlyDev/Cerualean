...
) : IUserService
{
	...
	public async Task<string> Login(LoginUserDto loginDto, CancellationToken cancellationToken = default)
	{
	...
	public async Task Register(RegisterUserDto registerDto, CancellationToken cancellationToken = default)
	{
	...
	public async Task RegisterAdmin(AdminUserDto adminDto, CancellationToken cancellationToken = default)
	{
